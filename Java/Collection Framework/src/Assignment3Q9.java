...
public class Assignment3Q9 {
    public static void main(String[] args) {
    	SavingAccount a1 = new SavingAccount(30300,1,"Neeraj",true);
    	SavingAccount a2 = new SavingAccount(1000,3,"Hari",true);
    	SavingAccount a3 = new SavingAccount(500000,4,"Raam",true);
    	SavingAccount a4 = new SavingAccount(13000,6,"Mrinal",true);
    	SavingAccount a5 = new SavingAccount(150000,7,"Sujith",true);
    	SavingAccount a6 = new SavingAccount(3000,2,"Shivang",true);
    	SavingAccount a7 = new SavingAccount(3000,15,"Yavin",true);
    	SavingAccount a8 = new SavingAccount(7000,14,"Yadhu",true);
